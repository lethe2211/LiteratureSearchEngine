  ...
  var Renderer = function(canvas){
    ...
    var that = {
	  ...
	  var nodeBoxes = {}
          ...
          if(flag == true) {
	      //console.log('posx: ' + hovered.point.x);
	      //console.log('posy: ' + hovered.point.y);
	      //console.log('distance: ' + hovered.distance);
	      //console.log('name: ' + hovered.node.name);
	      ctx.fillStyle = "black";
	    ...
	    console.log(node.name);
          ...
          ctx.stroke();
          ctx.fill();
          if(flag == 1 && hovered.node.name == node.name){
              ctx.fillStyle = "black";
